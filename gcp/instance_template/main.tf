...
data "google_compute_image" "image" {
  project = var.source_image != "" ? var.source_image_project : "ubuntu-os-cloud"
  name    = var.source_image != "" ? var.source_image : "ubuntu-1804-bionic-v20200716"
}

data "google_compute_image" "image_family" {
  project = var.source_image_family != "" ? var.source_image_project : "ubuntu-os-cloud"
  family  = var.source_image_family != "" ? var.source_image_family : "ubuntu-1804-lts"
}
